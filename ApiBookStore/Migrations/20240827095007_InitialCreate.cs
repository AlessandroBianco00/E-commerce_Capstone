    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WishlistBook", x => new { x.BooksBookId, x.WishlistsWishlistId });
                    table.ForeignKey(
                        name: "FK_WishlistBook_Books_BooksBookId",
                        column: x => x.BooksBookId,
                        principalTable: "Books",
                        principalColumn: "BookId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WishlistBook_Wishlists_WishlistsWishlistId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WishlistBook_WishlistsWishlistId",
                table: "WishlistBook",
