...
namespace ApiBookStore.Migrations
{
    ...
    [Migration("20240828083122_DeletedAtNotRequired")]
    partial class DeletedAtNotRequired
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApiBookStore.Models.Entities.Author", b =>
                {
            ...
            modelBuilder.Entity("ApiBookStore.Models.Entities.Book", b =>
                {
                    b.HasOne("ApiBookStore.Models.Entities.Author", "Author")
                        .WithMany("Books")
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ApiBookStore.Models.Entities.Discount", "Discount")
                        .WithMany()
                        .HasForeignKey("DiscountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ApiBookStore.Models.Entities.Translator", "Translator")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("ApiBookStore.Models.Entities.Cart", b =>
                {
                    b.HasOne("ApiBookStore.Models.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("ApiBookStore.Models.Entities.CartItem", b =>
                {
                    b.HasOne("ApiBookStore.Models.Entities.Book", "Book")
                        .WithMany("Carts")
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ApiBookStore.Models.Entities.Cart", "Cart")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("ApiBookStore.Models.Entities.Order", b =>
                {
                    b.HasOne("ApiBookStore.Models.Entities.ShippingAddress", "ShippingAddress")
                        .WithOne()
                        .HasForeignKey("ApiBookStore.Models.Entities.Order", "UserId")
            ...
            modelBuilder.Entity("ApiBookStore.Models.Entities.OrderItem", b =>
                {
                    ...
                    b.HasOne("ApiBookStore.Models.Entities.Order", "Order")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("BookCategory", b =>
                {
                    b.HasOne("ApiBookStore.Models.Entities.Book", null)
                        .WithMany()
                        .HasForeignKey("BooksBookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ApiBookStore.Models.Entities.Category", null)
                        .WithMany()
            ...
            modelBuilder.Entity("BookWishlist", b =>
                {
                    ...
                    b.HasOne("ApiBookStore.Models.Entities.Wishlist", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RoleUser", b =>
                {
                    b.HasOne("ApiBookStore.Models.Entities.Role", null)
                        .WithMany()
                        .HasForeignKey("RolesRoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ApiBookStore.Models.Entities.User", null)
                        .WithMany()
